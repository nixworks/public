...
# Malaysia's state investment company Khazanah Nasional announces plans to delist Malaysia Airlines and make it fully state-owned while the business is overhauled. 
...
1. [AP](http://hosted.ap.org/dynamic/stories/A/AS_MALAYSIA_AIRLINES_SHARES_SUSPENDED?SITE=AP&SECTION=HOME&TEMPLATE=DEFAULT)

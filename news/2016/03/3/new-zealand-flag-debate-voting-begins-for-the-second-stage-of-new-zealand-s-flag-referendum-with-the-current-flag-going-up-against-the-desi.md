...
# New Zealand flag debate: Voting begins for the second stage of New Zealand's flag referendum with the current flag going up against the design chosen on the first stage of the referendum. Voting will end on March 23 with polling showing the current flag is favoured to win. 

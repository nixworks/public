...
_Context: Guizhou, Anshun, coal mine, Puding County, outburst_
...
_Context: Russian Federation, internationalized country code, country code, .rf, Cyrillic script, top-level domain_
